...
<?php
  ...
  <strong>Sorry!</strong>Username already taken , Please try different username.
...
?>
            ...
            <div class="mb-3 col-md-6">
                ...
                <div id="emailHelp" class="form-text">Choose a strong password for your security.</div>
            </div>
